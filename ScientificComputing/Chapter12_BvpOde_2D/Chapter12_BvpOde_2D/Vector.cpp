...
void Vector::WriteVectorToFile(std::string FileName) const
{
    assert(!FileName.empty());

    std::ofstream writeVector(FileName);
    assert(writeVector.is_open());
    writeVector.setf(std::ios::scientific);
    writeVector.setf(std::ios::showpos);
    writeVector.precision(3);
